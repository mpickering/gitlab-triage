...
, servant-client, stdenv, text, time, connection, data-default, brick, microlens, vector, vty, generic-lens, lens, cursor, megaparsec
}:
mkDerivation {
  pname = "gitlab-triage";
  version = "0.1.0.0";
  ...
  executableHaskellDepends = [
    ...
    brick microlens vector vty generic-lens lens cursor megaparsec
  ];
  doHaddock = false;
